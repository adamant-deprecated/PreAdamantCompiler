...
namespace PreAdamant.Compiler.Tools.Lex
{
	public class Spec
	{
		...
		public Spec(string name, string ns, IDictionary<string, Spec> imports, IEnumerable<string> modes, IEnumerable<string> channels, IEnumerable<Fragment> fragments, IEnumerable<ModeBlock> modeBlocks)
		{
			Name = name;
			Namespace = ns;
